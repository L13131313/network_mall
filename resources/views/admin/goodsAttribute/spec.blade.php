                            ...
                            <div class="row" style="margin-top:50px;">
                                <div class="col-lg-5 col-md-offset-2">
                                    <div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-2">规格 <span style="color:red;">*</span></label>
                                        <div class="col-lg-10">
                                            <input class=" form-control" id="firstname" name="specName" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group">
