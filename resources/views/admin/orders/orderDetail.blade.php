          ...
          <table  class="table table-striped table-bordered">
              ...
              <tr>
                ...
                <TD width=111 height="23" align=right class=black>
                  ...
                  <TD colspan="3" class=black>{{ $v->addr }}</TD>
                </TR>
          ...
          <table border="0" cellpadding="0" cellspacing="0">
           ...
           <table  class="table table-striped table-bordered">
              ...
              <tr>
                ...
                <TD width=163>{{ $v->o_mtime }}</TD>
                </TR>
                <TR bgColor=#ffffff>
                <TD width=111 height="23" align=right class=black>
                    <DIV align=right>付款时间：</DIV></TD>
                <TD width=235>{{ $v->o_ptime }}</TD>

                <TD width=87>
                  <div align="right">确认时间：</div></TD>
                <TD width=163>{{ $v->o_otime }}</TD>
                </TR>
                <TR bgColor=#ffffff>
                <TD width=111 height="23" align=right class=black>
            ...
            <table   class="table table-striped">
              ...
              <tr>
                <td align=right><a href="{{ url('admin/OrderList') }}" class="btn btn-danger m-b-5">返回</a></td>
              </tr>
            </table>
