...
<script src="{{ asset('admin/js/modernizr.min.js') }}" type="text/javascript"></script>
...
<script src="{{ asset('admin/js/jquery.scrollto.min.js') }}" type="text/javascript"></script>
...
<!--Morris Chart-->
<script src="{{ asset('admin/js/raphael.min.js') }}" type="text/javascript"></script>
