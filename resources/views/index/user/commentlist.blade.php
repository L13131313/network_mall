...
@section('content')
<link href="{{ asset('index/css/appstyle.css') }}" rel="stylesheet" type="text/css">
		...
		<div class="comment-list">
			<div class="item-pic">
				<a href="#" class="J_MakePoint">
					<img src="{{ asset('index/images/comment.jpg_400x400.jpg') }}" class="itempic">
				</a>
			</div>
			...
			<div class="filePic">
				...
				<span>晒照片(0/5)</span>
				<img src="{{ asset('index/images/image.jpg') }}" alt="">
			</div>
