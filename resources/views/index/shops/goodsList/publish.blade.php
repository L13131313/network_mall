    ...
    <div class="row">
        <div class="col-lg-8 col-md-offset-2" style="border:1px solid #3e5ea2;margin-top: 25px;">
            ...
            <form class="" action="{{ url('shops/goods') }}" method="post" style="padding-top: 25px;" enctype="multipart/form-data">
                ...
                <br>
                <div class="row">
                    <div class="col-lg-11 col-md-offset-0.5">
                        @foreach($res as $val)
                ...
                <div id="isColor" style="width:520px;height:200px;background-color:#f1f1f1;" hidden>
                    ...
                    <a href="javascript:;" onclick="doYes()" class="layui-btn layui-btn-sm layui-btn-normal" style="margin-left:400px;margin-top:30px;">确定</a>
                </div>
                <br><br>
                <p>商品尺码</p>
                <br>
                @if ($spec->toArray() == [])
                    <input type="checkbox" name="spec[]" class="doCheckbox" lay-skin="primary" checked value="" hidden>
                @else
                    @foreach($spec as $n)
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        @if ($nav->toArray() == [])
                            <input type="radio" name="nav_id" lay-skin="primary" checked value="" hidden>
                        @else
                            @foreach($nav as $v)
                                <label class="label"><input type="radio" name="nav_id" lay-skin="primary" value="{{ $v->id }}"> {{ $v->nav_name }}</label>
                            @endforeach
                        @endif
                    </div>
                </div>
                ...
                <div class="layui-form-item" style="text-align:center;">
                    <button class="layui-btn" id="submit" lay-submit="" lay-filter="demo2">发布</button>
                </div>
            </form>
        </div>
    </div>
