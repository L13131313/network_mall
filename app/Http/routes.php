...
Route::group(['prefix' => 'index', 'middleware' => 'index'], function () {
	...
	Route::get('delFoot', 'index\FootController@del');
	...
	//购物车
	Route::get('shoppingcart','index\shoppingcart\shoppingcart@showList');
	Route::get('shoppingcart/addgoods/{gid}/{g_specid}/{count}','index\shoppingcart\shoppingcart@addgoods');
    Route::get('shoppingcart/deletegoods','index\shoppingcart\shoppingcart@destroy');
    Route::get('shoppingcart/empty','index\shoppingcart\shoppingcart@flush');
    Route::get('shoppingcart/account','index\shoppingcart\shoppingcart@account');

    //订单
    Route::resource('ShopOrders','index\orders\shopOrdersController');
    Route::post('ShopOrders/update','index\orders\shopOrdersController@updt');
    Route::post('ShopOrders/changeStatus','index\orders\shopOrdersController@changeStatus');
    // 2017-12-27 20:29:02买家修改默认地址
    Route::resource('addrDefault','index\addr\addrDefaultController');
 ...
 /**前台**/
	...
	//前台商品详情页面路由
	Route::get('index/goods','Index\Goods\GoodsController@show');
...
Route::group(['namespace' => 'Admin','prefix'=>'admin', 'middleware' => 'admin'], function () {
    ...
    Route::get('doOpen','user\publicUserController@doOpen');
    // 退出登录
...
/**后台**/
	...
	Route::post('admin/lunbo/doUpload', 'Admin\Lunbo\LunboController@doUpload');
	//后台轮播图管理
	...
	//前台投诉管理
	//订单投诉
	Route::resource('index/complaint','index\complaint\ComplaintController');
	Route::resource('complaint/list','index\complaint\ListController');

	// 商品路径
Route::get('/index/goods/{id}/{url}', 'Admin\Goods\GoodsController@showGoods');
